...
$ pipeline-generator
```
The default image for ci/cd pipeline is `"craftech/ci-tools:iac-tools-da54cf3"` and 
...
$ pipeline-generator -i "craftech/ci-tools:iac-tools-da54cf3" -e gitlab.foo.com -p gitlab
...
default:
  image: craftech/ci-tools:iac-tools-da54cf3
