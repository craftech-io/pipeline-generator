...
def render_ci_template(template_path: str, image_registry: str, extra_known_host: str):
    """
    ...
    :param extra_known_host: host to add to ~/.ssh/known_hosts in the pipeline file
    ...
    return ci_template.render(account_list=account_list, ci_path_list=ci_path_list, image_registry=image_registry,
                              extra_known_host=extra_known_host)
